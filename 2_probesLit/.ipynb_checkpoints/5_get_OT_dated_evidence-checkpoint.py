...
if __name__ == "__main__":
    ...
    parser.add_argument('--input', required=True, help='Path to the ner triplets with P-T pairs.')  # main dataset with OT evidence in data/ner_probes_triplets_ptpairs_ev.csv
