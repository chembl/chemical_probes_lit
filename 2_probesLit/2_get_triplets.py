...
def main(df_path, d_path):
    ...
    print("Total label ids:{}".format(dataset.label_id.count()))

    ## 3. creating probes-chembl dictionary to improve probes grounding
    ...
    print("Total labels after chembl improving:{}".format(dataset.label_id.count()))

    ## 4. Removing rows without OT grounding (comment this line if you want to keep all data but keep in mind all further analysis are done using OT ids)
